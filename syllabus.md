...
| [November 14](#week02) | Codeanywhere, namestorm | Create project space for each student, learn basic Javascript image handling |
| [November 21](#week03) | Name that tune | Guest speaker Joseph Moorer on basic sound engineering |
| [November 28](#week04) | Pong to Breakout | requestAnimationFrame, collision detection, event handling |
| [December  5](#week05) | Prince of Persia | Rotoscoping! Discuss turning filmed actions into character graphics |
| [December 12](#week06) | Tetris | Context transforms, color, random numbers |
...
| [January   9](#week07) | Asteroids to Flappy Bird | Physics!, irregular shapes and random levels, discuss speaking at Stir Trek |
...
Post-op: We covered some of Game of Life in week 1, but we need to return to array handling. This week we set up code repositories for all the students on the Codeanywhere site, and did some basic image manipulation.

### <a name="week03"> Week 3, November 21

This week we'll work on some basic sound engineering, with the goal of adding a sountrack and sound effects into the game. Since this is not my area of expertise, I've asked a long-time friend of the family, Joseph Moorer, DJ and R&B singer with the local group The Conspiracy Band, to join us, and introduce the group to some sound mixing software.

After this, any group member who wants to work with sound can do so in the second half of each meeting, and in a later week I'll cover pulling sounds into the game with HTML5 audio.
